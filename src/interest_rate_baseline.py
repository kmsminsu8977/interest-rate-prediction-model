...
PROJECT = {"analysis_type": "interest_rate", "category": "Stochastic Models & Market Risk", "columns": ["date", "policy_rate", "inflation_yoy", "unemployment_rate", "term_spread", "credit_spread"], "methods": ["각 거시 변수를 표준화한 뒤 직관적 부호를 반영한 선형 점수로 변환한다.", "점수는 방향성 학습용이며 실제 중앙은행 반응함수를 대체하지 않는다.", "데이터는 합성 macro panel로 구성했다."], "module_name": "interest_rate_baseline", "objective": "거시 변수의 방향성 신호를 단순 점수화해 다음 금리 변화 압력을 추정한다.", "question": "물가, 고용, 기간스프레드, 신용스프레드는 금리 상방/하방 압력을 어떻게 다르게 만든다?", "rows": [["2025-09", 0.0325, 0.028, 0.037, 0.006, 0.012], ["2025-10", 0.0325, 0.031, 0.036, 0.005, 0.013], ["2025-11", 0.035, 0.033, 0.035, 0.004, 0.014], ["2025-12", 0.035, 0.029, 0.036, 0.002, 0.017], ["2026-01", 0.035, 0.026, 0.038, -0.001, 0.021], ["2026-02", 0.0325, 0.024, 0.04, -0.003, 0.024]], "sample_name": "macro_rate_panel.csv", "title_en": "Interest Rate Prediction Model", "title_ko": "금리 예측 모델"}
